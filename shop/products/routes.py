...
def get_category(id):
    ...
    get_cat_pro = Addproduct.query.filter_by(category=get_cat).paginate(page=page, per_page=4)
...
def addproduct():
    ...
    if request.method =="POST":
        ...
        description=desc, brand_id=brand, category_id=category, image_1=image_1, image_2=image_2, image_3=image_3)
